(function() {
  ...
  _.every = function(collection, iterator) {
    ...
    return _.reduce(collection, function(start, item) {
  ...
  _.shuffle = function(array) {
    ...
    _.each(copy, function(item, index) {
      var shuffler = Math.floor(Math.random() * copy.length);
      var temp = item;
      copy[index] = copy[shuffler];
      copy[shuffler] = temp;
    });
    return copy;
  };
  ...
  _.zip = function() {
    ...
    var tempResult = new Array(maxLength);
    var result = [];
  ...
  _.flatten = function(nestedArray, result) {
    while(_.some(nestedArray, function(item) { return Array.isArray(item)})) {
      nestedArray = _.reduce(nestedArray, function(a,b){
        return a.concat(b);
      }, []);
    }
    return nestedArray;
